    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('incomes.create') }}" class="btn btn-primary">
                <i class='bx bx-plus'></i> Nuevo Ingreso
            </a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @forelse($incomes as $income)
                            <tr>
                                ...
                                <td>
                                    @if($income->invoice_path)
                                        <a href="#" class="view-invoice" 
                                           data-bs-toggle="modal" 
                                           data-bs-target="#invoiceModal"
                                           data-title="Ingreso: {{ $income->type->name }} - {{ $income->date->format('d/m/Y') }}"
                                           data-image="{{ Storage::url($income->invoice_path) }}">
                                            <img src="{{ Storage::url($income->invoice_path) }}" 
                                                 alt="Factura" 
                                                 class="img-thumbnail" 
