        ...
        <div class="card-body">
            <form action="{{ route('incomes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="income_type_id" class="form-label">Tipo de Entrada</label>
                            <select class="form-select @error('income_type_id') is-invalid @enderror" 
                                    id="income_type_id" name="income_type_id" required>
